  ...
  return (
      <div className="MobileBar">
          <ul>
            ...
            <li className={activePage === 'people' ? 'active':''} onClick={() => handleSetActivePage('people')}><Link to="/sobrenos"><BsFillPeopleFill color={activePage === 'people' ? '#3ce2fb' : '#b5b6b7'} size={32}/></Link></li>
          </ul>
      </div>
  )
}
